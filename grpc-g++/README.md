...
>1. I hold a public key of a trusted CA.
>2. Verify the signature to ensure the certificate is issued by the trusted CA.
>3. Challenging the counterpart to prove private key (inside the certificate) ownership.
